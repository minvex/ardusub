...
void Sub::circle_run()
{
    ...
    if (circle_pilot_yaw_override) {
        ...
        attitude_control.input_euler_angle_roll_pitch_yaw(channel_roll->get_control_in(), channel_pitch->get_control_in(), circle_nav.get_yaw() - 9000, true, get_smoothing_gain());
    }
